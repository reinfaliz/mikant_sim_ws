...
namespace sail_luffing_controller_plugin
{
	class SailLuffingControllerPlugin : public gazebo::ModelPlugin
	{
		public: 
			...
			void callbacksub1(const std_msgs::msg::Float64MultiArray::SharedPtr msg);
			void callbacksub2(const std_msgs::msg::Float64MultiArray::SharedPtr msg);
		...
		private: 
			 ...
			 double x,y,phi,psi,u,v,p,r,vawu,vawv,alpha_aw;
			 double sail_angle;
			 double alpha_tw;
